...
// {name, capital, avatar, isIncrease}

export const ForbesListItem = ({ forbesItemData }) => {
  const { name, capital, avatar, isIncrease } = forbesItemData;
  return (
    <ForbesItem>
...
ForbesListItem.propTypes = {
  forbesItemData: PropTypes.shape({
